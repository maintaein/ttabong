...
VALUES
    (1, 4, 1, '하천 정화 활동', '서울 강남구 청담천', 'ALL', '김담당', '010-1111-1111', '하천 주변의 쓰레기를 정리하는 봉사입니다.', FALSE, NOW()),
    (1, 4, 2, '도시 숲 가꾸기', '서울 강남구 양재 시민의 숲', 'ALL', '박책임', '010-2222-2222', '도시 내 숲을 가꾸고 보호하는 활동입니다.', FALSE, NOW()),
    -- 굿네이버스(기관 1번)의 두 번째 그룹(아동 교육 지원)
    (2, 4, 3, '초등학생 학습 멘토링', '서울 종로구 어린이도서관', 'YOUTH', '이강사', '010-3333-3333', '초등학생 대상 학습 지도 및 멘토링.', FALSE, NOW()),
    (2, 4, 4, '저소득층 아동 영어 교육', '서울 동대문구 청소년센터', 'YOUTH', '최관리', '010-4444-4444', '경제적 어려움을 겪는 아동을 위한 영어 수업 지원.', FALSE, NOW()),
    -- 초록우산어린이재단(기관 2번)의 첫 번째 그룹(노인 돌봄 활동)
    (3, 5, 5, '경로당 청소 및 식사 지원', '부산 수영구 경로당', 'ADULT', '장센터', '010-5555-5555', '노인을 위한 청소 및 식사 제공 봉사.', FALSE, NOW()),
    (3, 5, 6, '독거노인 말벗 봉사', '부산 해운대구 독거노인 센터', 'ADULT', '홍담당', '010-6666-6666', '혼자 사시는 노인분들과 대화 및 산책 봉사.', FALSE, NOW()),
    -- 초록우산어린이재단(기관 2번)의 두 번째 그룹(동물 보호 봉사)
    (4, 5, 7, '유기견 보호소 봉사', '대전 유기견 보호소', 'ALL', '김보호', '010-7777-7777', '유기견 보호소에서 강아지 돌봄 봉사.', FALSE, NOW()),
    (4, 5, 8, '길고양이 급식소 운영', '대전 중앙시장', 'ALL', '이집사', '010-8888-8888', '길고양이 급식소를 운영하며 보살피는 활동.', FALSE, NOW());
