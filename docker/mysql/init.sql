...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='전체 유저 정보 테이블';
...
-- updated_at       DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '최종 수정 일시',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='봉사자 추가 정보 테이블';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='봉사기관 기본 정보';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='봉사공고 신청 상태 관리 테이블';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='후기 테이블';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='후기에 대한 댓글 테이블';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='봉사자가 좋아요한 공고 정보';
...
VALUES (1, '123-45-67890', '희망나눔센터', '이명수', '서울특별시 종로구 세종대로 1', NOW()),
...
-- Template 테이블 데이터 삽입
INSERT INTO Template (group_id, org_id, category_id, title, activity_location, status, contact_name, contact_phone,
                      description, is_deleted, created_at)
VALUES (1, 1, 1, '한강 플로깅', '서울특별시 한강공원', 'ALL', '박지훈', '010-1234-5678', '한강에서 쓰레기를 줍는 봉사 활동입니다.', FALSE, NOW()),
       (2, 2, 2, '무료 영어 교육', '부산광역시 초등학교', 'YOUTH', '김선영', '010-2345-6789', '초등학생을 대상으로 무료 영어 수업을 진행합니다.', FALSE,
        NOW()),
       (3, 3, 3, '유기동물 보호소 돕기', '대구광역시 동물보호센터', 'ADULT', '이철호', '010-3456-7890', '유기동물 보호소에서 봉사 활동을 진행합니다.', FALSE,
        NOW()),
       (4, 4, 4, '노인복지센터 봉사', '인천광역시 노인복지센터', 'ALL', '최미경', '010-4567-8901', '노인복지센터에서 말벗 및 환경미화 봉사를 진행합니다.', FALSE,
        NOW()),
       (5, 5, 5, '아동복지센터 후원', '대전광역시 아동복지센터', 'YOUTH', '정예진', '010-5678-9012', '아동복지센터에서 아이들과 함께하는 프로그램을 운영합니다.', FALSE,
        NOW());

INSERT INTO Recruit (template_id, deadline, activity_date, activity_start, activity_end, max_volunteer,
                     participate_vol_count, status, is_deleted, updated_at, created_at)
VALUES (1, NOW(), '2025-03-01', 9.00, 12.00, 10, 5, 'RECRUITING', FALSE, NOW(), NOW()),
...
VALUES (1, 1, 'PENDING', FALSE, FALSE, NOW(), NOW()),
...
INSERT INTO Review (parent_review_id, group_id, recruit_id, org_id, writer_id, title, content, is_deleted, is_public,
                    img_count, updated_at, created_at)
VALUES (NULL, 1, 1, 1, 1, '봉사 후기 - 한강 플로깅', '정말 보람찬 시간이었습니다!', FALSE, TRUE, 2, NOW(), NOW()),
       (NULL, 2, 2, 2, 2, '봉사 후기 - 무료 영어 교육', '아이들에게 영어를 가르쳐주는 것이 너무 즐거웠어요.', FALSE, TRUE, 3, NOW(), NOW());

INSERT INTO Review_image (template_id, review_id, image_url, is_deleted, is_thumbnail, created_at)
VALUES (1, 1, 'https://example.com/review1_image1.jpg', FALSE, TRUE, NOW()),
...
VALUES (2, 1, '정말 멋진 후기네요! 저도 참여하고 싶어요!', FALSE, NOW(), NOW()),
