...
const TemplateAndGroup: React.FC = () => {
  const navigate = useNavigate();
  const { groups, isLoading, error, fetchTemplates, deleteTemplate, deleteGroup } = useTemplateStore();
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 bg-gray-50 p-4 space-y-6 mb-24">
        {groups && groups.length > 0 ? (
          groups.map((group) => (
            <Card key={group.groupId} className="p-4 bg-white shadow-md">
                      ...
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex gap-3 text-sm">
                          ...
                          <button
                            ...
                            onClick={() => openDeleteDialog('template', group.groupId, template.templateId)}
                          >
                            삭제
                          </button>
                        </div>
